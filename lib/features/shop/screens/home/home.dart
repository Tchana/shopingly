...
import 'package:shopingly/features/shop/screens/all_products/all_products.dart';
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  ShopinglySectionHeading(title: "Popular Products", onPressed: ()=>Get.to(()=>AllProducts()),),
                  SizedBox(height: ShopinglySizes.spaceBtwItems),
